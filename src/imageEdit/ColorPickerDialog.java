 ...
 * @Description:  画笔颜色选择器对话框
 * @Author: Mr.Simple (何红辉)
 * @E-mail: bboyfeiyu@gmail.com 
 * @Date 2012-11-18 下午12:35:36 
 *
 */
...
public class ColorPickerDialog extends Dialog {
    ...
    private OnColorChangedListener mListener;	// 颜色改变监听器
     ...
     * @Description:   ColorPickerView扩展控件
     * @Author: Mr.Simple (何红辉)
     * @E-mail: bboyfeiyu@gmail.com 
     * @Date 2012-11-18 下午12:37:14 
     *
     */
    private class ColorPickerView extends View {
		...
		public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                	...
                	if(debug) Log.v(TAG, "[MOVE] 高亮: " + highlightCenter + "微亮: "
		...
		/**
		 * @Method: inColorCircle
		 * @Description: 坐标是否在色环上
		 * @param x     坐标
		 * @param y     坐标
    ...
    /**
     * @ClassName: OnColorChangedListener 
     * @Description:  颜色改变的回调接口
     * @Author: Mr.Simple (何红辉)
     * @E-mail: bboyfeiyu@gmail.com 
     * @Date 2012-11-18 下午12:40:18 
     *
     */
    public interface OnColorChangedListener {
    	
    	/**
    	 * 功能 ： 回调函数       @param color 选中的颜色
    	 */
